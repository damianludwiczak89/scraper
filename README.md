This is just a scraper to check price of laptop daily using GitHub Actions. Had to use Selenium because simple request did not gather data correctly from the site.
